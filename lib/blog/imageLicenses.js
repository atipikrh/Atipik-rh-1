...
export const imagesLocalesBlog = [
  ...
  },
  {
    ...
    dossierPublic: 'public/images/blog/',
    note:
      'Visuel brand ATIPIK RH — Formation CIP, session mars 2027 (Lormont, 14 places, démarrage 22/03/2027). Création interne / charte graphique.',
  },
  {
  ...
  {
    chemin: '/images/blog/neurodiversite-inclusion-recrutement.png',
    slugsArticles: ['neurodiversite-inclusion-recrutement'],
    usage: 'Vignette hero listing et page article.',
    statutDocumentaire: 'creation_ia_placeholder',
    dossierPublic: 'public/images/blog/',
    note:
      'Visuel hero généré par IA pour l’article du 1er octobre 2026 (neurodiversité / inclusion au recrutement). Remplacer par un visuel charte ATIPIK RH si disponible.',
  },
  {
    chemin: '/images/blog/experience-professionnelle-non-reconnue-vae.png',
    slugsArticles: ['experience-professionnelle-non-reconnue-vae'],
    usage: 'Vignette hero listing et bannière inline dans le contenu HTML.',
    statutDocumentaire: 'creation_ia_placeholder',
    dossierPublic: 'public/images/blog/',
    note:
      'Visuel hero généré par IA pour l’article du 24 septembre 2026 (VAE / expérience professionnelle non reconnue). Remplacer par un visuel charte ATIPIK RH si disponible.',
  },
  {
    chemin: '/images/blog/recrutement-inclusif-objectiver-criteres.jpg',
    slugsArticles: ['recrutement-inclusif-objectiver-criteres'],
    usage: 'Vignette hero listing et page article.',
    statutDocumentaire: 'creation_ia_placeholder',
    dossierPublic: 'public/images/blog/',
    note:
      'Visuel hero généré par IA pour l’article du 17 septembre 2026 (recrutement inclusif / grille de compétences). Remplacer par un visuel charte ATIPIK RH si disponible.',
  },
  {
    chemin: '/images/blog/formation-cip-ou-fpa-quelle-certification-choisir.jpg',
    slugsArticles: ['formation-cip-ou-fpa-quelle-certification-choisir'],
    usage: 'Vignette hero listing et page article.',
    statutDocumentaire: 'creation_ia',
    dossierPublic: 'public/images/blog/',
    note:
      'Visuel hero IA retenu pour l’article comparatif CIP ou FPA (publication 29 septembre 2026). Charte ATIPIK RH (navy #013F63, accent orange #FE6400). Scène CIP (entretien) / FPA (animation).',
  },
  {
    chemin: '/images/blog/recrutement-sans-discrimination-points-controle.jpg',
    slugsArticles: ['recrutement-sans-discrimination-points-controle'],
    usage: 'Vignette hero listing et page article.',
    statutDocumentaire: 'creation_ia_placeholder',
    dossierPublic: 'public/images/blog/',
    note:
      'Visuel hero généré par IA pour l’article du 15 septembre 2026 (entretien structuré / grille d’évaluation). Remplacer par un visuel charte ATIPIK RH si disponible.',
  },
  {
