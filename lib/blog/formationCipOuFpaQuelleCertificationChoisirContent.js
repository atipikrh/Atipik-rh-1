...
export const formationCipOuFpaQuelleCertificationChoisirContent = `
        ...
        <p>La <a href="/formations/cip"><strong>formation CIP Bordeaux</strong></a> proposée par ATIPIK RH se déroule à <strong>Lormont</strong>, en présentiel, sur <strong>948 heures</strong> (563 h en centre, 385 h de stage). La prochaine session est prévue du <strong>22 mars 2027 au 22 octobre 2027</strong>.</p>
        ...
        <p>Les deux titres peuvent être financés selon le profil, notamment via le <a href="https://www.moncompteformation.gouv.fr" rel="noopener noreferrer" target="_blank"><strong>CPF — Mon Compte Formation</strong></a>. Le détail des dispositifs est présenté sur la page <a href="/financement"><strong>Financement</strong></a>. Si vous justifiez déjà d'une expérience significative, une <a href="/blog/experience-professionnelle-non-reconnue-vae"><strong>VAE CIP ou FPA</strong></a> peut aussi être étudiée avant une formation longue.</p>
...
export const formationCipOuFpaQuelleCertificationChoisirInternalLinks = [
  ...
  {
    label: 'Expérience non reconnue : pourquoi choisir la VAE ?',
    href: '/blog/experience-professionnelle-non-reconnue-vae',
    type: 'article',
  },
]
