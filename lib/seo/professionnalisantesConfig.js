 ...
 */
function appendCourteUtm(params, campaign) {
...
export function getCourteRappelHref(slug) {
  ...
  appendCourteUtm(params, slug || 'formations-courtes')
  return `/contact?${params.toString()}`
}
...
export function getCourteHubContactHref() {
  const params = new URLSearchParams()
  params.set('sujet', CONTACT_SUJET_COURTE)
  appendCourteUtm(params, 'formations-courtes')
  return `/contact?${params.toString()}`
}
