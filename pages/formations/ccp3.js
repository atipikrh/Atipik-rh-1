...
const REUNION_HREF = getCertifianteReunionHref('formation-ccp3')
        ...
        <div className="relative z-10">
          ...
          <section className="pt-4 pb-4">
            <div className="container mx-auto px-4">
              ...
              <FormationQuickAnswers briefId="formation-ccp3" />
              <FormationLandingCtas briefId="formation-ccp3" />
          ...
          <section id="dates" className="pt-2 pb-8 scroll-mt-24">
            <div className="container mx-auto px-4">
              <div className="max-w-5xl mx-auto">
                ...
                <FormationAdequation briefId="formation-ccp3" />
