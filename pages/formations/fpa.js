                  ...
                  <div className="space-y-3 flex-grow flex flex-col justify-between">
                    ...
                    <div className="flex items-start gap-2">
                      ...
                      <div>
                        ...
                        <p className="text-blue-100 text-sm mb-2">Niveau 5 - titre <a href="https://www.francecompetences.fr/recherche/rncp/37275/" target="_blank" rel="noopener noreferrer" className="text-blue-200 hover:text-white underline transition-colors">RNCP37275</a></p>
                        <p className="text-blue-100 text-sm mb-1">Date de début des parcours certifiants : 29-04-2023</p>
                        <p className="text-blue-100 text-sm">Date d'échéance de l'enregistrement : 29-04-2028</p>
                    </div>
                </div>
